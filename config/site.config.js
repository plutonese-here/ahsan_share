...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'plutoneseahsan@tpkvd.onmicrosoft.com',
  ...
  protectedRoutes: ['/Private', '/Public/Private'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:mail@ahsan.info.bd',
